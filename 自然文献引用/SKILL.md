...
When the user writes in Chinese, asks for "Nature绯诲垪", "CNS鍙婂叾瀛愬垔", "鏀拺鏂囩尞",
"琛ュ紩鐢?, "鑷姩缁欏嚭寮曠敤", "鍒嗘寮曠敤", "瀵煎嚭EndNote", "RIS", "Zotero", "RDF", or provides Chinese manuscript text:
...
- Flag overclaiming clearly in Chinese: `寮烘敮鎾慲, `閮ㄥ垎鏀拺`, `鑳屾櫙鏀拺`, `涓嶅缓璁紩鐢ㄤ负璇ュ彞鏀拺`.
...
- `Nature绯诲垪`: search Nature Portfolio first. Include `Nature`, `Nature [field]`,
...
- `CNS鍙婂叾瀛愬垔` or `CNS/sister journals`: search only accepted flagship and subjournal titles in
